...
<head>
    ...
    <!-- CUSTOM CSS -->
    <link href="assets/css/custom_css/custom-tampilan-awal.css" rel="stylesheet">
    <!-- END OF CUSTOM CSS -->
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="<?php echo base_url('mendaftar');?>">Daftar</i></a></li> 
    ...
    <!-- CUSTOM SCRIPT -->
    <script type="text/javascript" src="assets/js/custom-tampilan-awal.js"></script>  
    <!-- END OF SCRIPT CSS --> 
</body>
</html>
